...
<html>
    <head>
        ...
        <link rel="stylesheet" href="recursos/css/ingresarpedidosterminados.css">
        ...
        <div id="solicitudespedidos">
            <div class="container">
                <div class="content-center">
                    <h2>INGRESAR PEDIDOS TERMINADOS</h2>
                </div>
                <div class="row">
                    <table class="table" style="background-color: #ffff; text-align: center;">
                        <thead class="black white-text">
                            <tr>
                                ...
                                <th scope="col">FECHA DE PRODUCCIÓN TERMINADA</th>
                                <th scope="col">CONFIRMAR INGRESO</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- se listan los pedidos terminados -->
                            <jsp:include page="WEB-INF/paginas/jefealmacen/pedidosterminados.jsp" />
                        </tbody>
                    </table>
                </div>
            </div>
