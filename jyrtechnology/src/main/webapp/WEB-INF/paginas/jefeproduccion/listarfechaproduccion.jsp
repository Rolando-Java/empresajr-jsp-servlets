                ...
                <tr style="vertical-align: middle;">
                    ...
                    <td>
                        <select class="browser-default custom-select" name="estadoProduccion">
                            <option <c:if test="${pedido.producciones.get(pedido.producciones.size()-1).estado.equalsIgnoreCase('produccioniniciada')}">selected</c:if> value="produccioniniciada">Producción iniciada</option>
                            <option <c:if test="${pedido.producciones.get(pedido.producciones.size()-1).estado.equalsIgnoreCase('produccionpausa')}">selected</c:if> value="produccionpausa">Producción en pausa</option>
                            <option <c:if test="${pedido.producciones.get(pedido.producciones.size()-1).estado.equalsIgnoreCase('produccionavance')}">selected</c:if> value="produccionavance">En producción</option>
                            <option <c:if test="${pedido.producciones.get(pedido.producciones.size()-1).estado.equalsIgnoreCase('produccionterminada')}">selected</c:if> value="produccionterminada">Producción concluida</option>
